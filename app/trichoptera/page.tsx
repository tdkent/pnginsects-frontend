        ...
        <article className="article-container">
          ...
          <section className="intro">
            <div className="intro-text">
              <p>
                Trichoptera, commonly known as caddisflies, are closely related
                to Lepidoptera (butterflies and moths) and share some
                similarities in appearance, such as having scaled wings.
                However, caddisflies can be distinguished by their unique
                tent-like shape and behavioral traits.
              </p>
              <p>
                ...
                They have two pairs of hairy, membranous wings that are held in
                a tent-like manner over their bodies when at rest. The wings are
                often adorned with intricate patterns, varying in coloration
                from translucent to dark brown or black.
              </p>
            </div>
