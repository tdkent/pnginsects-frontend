...
const Header = () => {
  ...
  return (
    <header className="z-50 flex h-[64px] w-screen items-center justify-between bg-gradient-to-r from-primary-900 to-primary-700 px-5 dark:bg-gradient-to-b dark:from-primary-900 dark:to-black max-lg:dark:from-25% sm:h-[72px] md:px-8 lg:sticky lg:top-0 lg:bg-gradient-to-b">
      <div className="flex items-center gap-x-6 md:gap-x-9 lg:gap-x-12">
        <Link href="/">
          <h1
            className="text-primary-300 dark:text-primary-50 sm:text-2xl lg:text-3xl xl:text-4xl"
