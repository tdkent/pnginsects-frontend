    ...
    <div className="flex flex-row-reverse">
      ...
      <article className="w-4/5">
        ...
        <section>
          ...
          <p>
            Identification Tips: Beetles have a distinct appearance with their
            hardened forewings covering the abdomen. Their antennae vary in
            shape and can be clubbed, serrated, or thread-like. Look for the
            presence of chewing mouthparts and the ability to fly. Pay attention
            to their size, colour patterns, and unique adaptations such as horns
            or modified body structures.
          </p>
        </section>
