        ...
        <article className="article-container">
          ...
          <section className="intro">
            <div className="intro-text">
              <p>
                Orthoptera encompasses insects such as grasshoppers, crickets,
                and katydids. They are characterized by their strong hind legs
                adapted for jumping, well-developed wings (in some species), and
              ...
              <p>
                ...
                short. Crickets have flattened bodies and long antennae, and
                their songs are produced by rubbing their wings together. They
                are often darkly coloured. Katydids are often leaf-like with
                long antennae and can produce loud, rhythmic songs. Pay
                attention to their body shape, leg structure, and presence of
                wings.
              </p>
            </div>
