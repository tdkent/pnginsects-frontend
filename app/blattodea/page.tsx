      ...
      <article className="w-4/5">
        ...
        <section>
          ...
          <p>
            ...
            body, with a shield-like pronotum covering their head. They
            typically have long, filamentous antennae and chewing mouthparts.
            Most cockroaches are brown or black in colour, and their size can
            vary from small to large. Look for the characteristic rapid and
            darting movement when disturbed, as well as the presence of wings in
            some species.
          </p>
          <p>
